...
const safetyLevels = {
    5: { color: '#64C750', text: 'Пластик' },
    4: { color: '#FFBD3F', text: 'Картон' },
    3: { color: '#E55D47', text: 'Стекло' },
    2: { color: '#772613', text: 'Батарейки' },
    1: { color: '#121212', text: 'Аллюминий' }
};
...
fetch('./json/eco.json')
    ...
    .then(data => {
        ...
        mapTitleElement.textContent = "Пункты приема"; // Установите нужный текст
